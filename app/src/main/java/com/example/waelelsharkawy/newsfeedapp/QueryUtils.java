    ...
    private static List<News> extractFeatureFromJson(String newsJSON) {
        ...
        try {
            ...
            for (int i = 0; i < newsArray.length(); i++) {
                ...
                String web_url = currentNews.getString("webUrl");
                String article_name = currentNews.getString("webTitle");
                String section_name = currentNews.getString("sectionName");
                String publish_date = currentNews.getString("webPublicationDate");
                ...
                if (tagsAuthor.length() != 0) {
                    for (int j = 0; j < tagsAuthor.length(); j++) {
                        ...
                        author_name = "By" + currentTagsAuthor.getString("webTitle");
                    }
                } else {
                    author_name = "No Author";
                }

                News theNews = new News(article_name, section_name, author_name, publish_date, web_url);
